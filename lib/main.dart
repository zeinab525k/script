...
Future<void> runCmdCommand(String command) async {
  try {
    ...
    // Using start
    // Execute the command with 'sh' (Bash) shell on macOS, and 'cmd' on windoes.
    ...
    stdoutStream.listen((stdoutData) {
      print('STDOUT: $stdoutData');
    });
    stderrStream.listen((stderrData) {
    ...
    print('Failed to run CMD command: $e');
  }
}
